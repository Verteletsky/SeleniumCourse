...
class TestAllSystem(unittest.TestCase):
    ...
    def test_registration1(self):
        ...
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Test success!")
    ...
    def test_registration2(self):
        ...
        # с помощью assert проверяем, что ожидаемый текст совпадает с текстом на странице сайта
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Test success failed!")
